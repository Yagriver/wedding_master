...
- A protected finance page (`finance.html`) for EUR quotes, contracts, item-level IVA, deadlines, paid status, automatic completion, and monthly outstanding totals.
